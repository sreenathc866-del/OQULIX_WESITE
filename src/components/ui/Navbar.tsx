            ...
            <div className={`w-full bg-white transition-all duration-300 ${scrolled ? 'py-2' : 'py-2 md:py-3'}`}>
                <div className="container mx-auto px-6 md:px-8 flex justify-between items-center max-w-[1400px]">
                    <div className="flex items-center space-x-8 md:space-x-12">
                        {/* Custom Brand Logo matching the official design */}
                        <a href="/" className="flex items-center group">
                            {/* Replaced with uploaded PNG Logo (inverted to be visible on white bg) */}
                            <img
                                src="/oqulix logo.png"
                                alt="OQULIX Logo"
                                className="h-10 md:h-12 w-auto invert transition-transform duration-300 group-hover:scale-105 object-contain"
                            />
                        </a>
