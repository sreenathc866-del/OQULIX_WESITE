        ...
        <section className="relative py-24 bg-gray-50 border-t border-gray-100">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="section-title text-gray-900 mb-4">What Our <span>Clients Say</span></h2>
                </div>
                        ...
                        {testimonialsData.map((testimonial, index) => (
                            <div key={index} className="min-w-full px-4">
                                <div className="bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-gray-100 text-center flex flex-col items-center justify-center min-h-[300px] h-auto lg:h-[300px]">
                                    ...
                                    <p className="card-desc text-gray-700 mb-8 italic">"{testimonial.quote}"</p>
                                    <div>
                                        <h3 className="card-title text-gray-900">{testimonial.author}</h3>
                                        <p className="btn-text text-blue-600 uppercase tracking-wider">{testimonial.position}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
